...
class GUI:
    ...
    def choose2d(self):
        ...
        button_ellipse = tk.Button(self.master, text="ellipse / circle", width=20)
    ...
    def rectangle_data_window(self):
        ...
        button_next = tk.Button(self.master, text="next", width=20, command=lambda: self.plot_figure("figure"))
        button_next.grid(row=5, column=0, columnspan=2)
    ...
    def plot_figure(self, figure):
        ...
        if figure == "ellypse":
            ...
            # running animation
            ani.animation(custom(lop, 100), 50, self.eqt, self.var)
